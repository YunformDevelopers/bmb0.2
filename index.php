...
<div id='slideshow' style="" >
	<div class="slideshow-inner">
        ...
        <p><a style="color:#F30; border-color:#F30;" href="beta-intro.php">内测福利戳这里！</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="create.php">开始创建第一张报名表</a></p>
    </div>
</div>
		...
		<li class="innerWrapper">
			<div id='newest' class="section">
                ...
                <!-- 我写的css对新生成的DOM元素不能起作用，很奇怪 -->
					<?php 
						connect();
						$result=mysql_query("select * from question where formstate=1 order by form_id desc limit 4") or die(mysql_error());
